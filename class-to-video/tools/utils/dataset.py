        ...
        **super_kwargs,                                 # Additional arguments for the Dataset base class.
        ...
        for o in objects[1:]:
            ...
            if self._file_ext(o) == '.jpg':
                ...
                # if curr_d in self._video_dir2frames:
                #     print(f'{curr_d}:{len(self._video_dir2frames[curr_d])} {self._video_dir2frames[curr_d][0]}, {self._video_dir2frames[curr_d][-1]}')
                curr_d = o
        ...
        if len(self._video_idx2frames) == 0:
            raise IOError(f'No videos found in the specified archive in path {path}')
