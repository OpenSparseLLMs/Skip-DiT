...
if __name__ == "__main__":
    ...
    parser.add_argument("--deepcache", type=str, default='')
    ...
    if len(args.deepcache) > 0:
        omega_conf.model = omega_conf.model+'-'+args.deepcache
    print(f'use model: {omega_conf.model}')
