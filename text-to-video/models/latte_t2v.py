...
class LatteT2V(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        record = False
        record_path = '/mnt/petrelfs/chenguanjie/cgj/Latte-skip/features/Latte-1/'
        if record:
...
if __name__ == '__main__':
    ...
    network = LatteT2V.from_pretrained("/mnt/petrelfs/share_data/cgj/Latte-1", subfolder="transformer", low_cpu_mem_usage=False, device_map=None, video_length=16).to(device,  dtype=torch.float16)
